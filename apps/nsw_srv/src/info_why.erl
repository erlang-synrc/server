...
tr() ->
    [
        ...
        #panel{class="info-page-content-panel", body=[
            ...
            #panel{style="left:331px; top:425px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Harcadığım zamanın ve uğraşın bir şekilde bana <b>geri dönmesini</b>")++"</nobr><br />"++?_T("istiyorum,")},
            #panel{style="left:346px; top:467px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Sanal oyun ortamında <b>mouse-parmaktan</b> ibaret sanal oyuncu")++"</nobr><br />"++?_T("olmaktan sıkıldım.")},
            #panel{style="left:365px; top:507px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Oyunlarda ulaşmak için çaba gösterebileceğim <b>farklı hedefler</b>")++"</nobr><br />"++?_T("olsun istiyorum,")},

            #panel{style="left:291px; top:575px; font-size:40px; color:#FC6404;",body=?_T("Daha başka şeyler arıyorum!")}
        ]},
        #panel{class="info-page-content-panel", body=[
            #panel{style="left:91px; top:667px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Sanal ortamın <b>görünmez duvarları</b> arkasına sığınıp, önüne gelene")++"</nobr><br />"++?_T("bulaşanlardan ve <b>yarım kalan</b> oyunlardan sıkıldım,")},
            ...
            #panel{style="left:155px; top:769px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Avatar yükleme, direk mesaj, nick seçimi, arkadaş listesi, tüm")++"</nobr><br /><nobr>"++?_T("odalara girebilme ayrıcalığı, ne işe yaradığı kendinden menkul")++"</nobr><br /><nobr>"++?_T("fazla puan kazanma gibi her yerde ancak verebildikleri <b>“paran")++"</nobr><br /><nobr>"++?_T("ile caka satmak”</b> babından özelliklere “bilmem ne üyeliği”")++"</nobr><br />"++?_T("adı altında haybeden para ödemek istemiyorum,")},
            #panel{style="left:172px; top:872px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Benim <b>rahatım</b> ve <b>beklentilerim</b> için çaba gösterildiğini")++"</nobr><br />"++?_T("görmek istiyorum,")},

            #panel{style="left:189px; top:912px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>Kısacası beni “<b>Yolunacak tavuk gibi</b>” görmelerinden")++"</nobr><br />"++?_T("hoşlanmıyorum,")},
        ...
        #panel{class="info-page-content-panel", body=[
            #panel{style="left:179px; top:1207px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• Her şeyi</b>, oyuncunun kendini <b>rahat</b> hissetmesi, bulunduğu")++"</nobr><br /><nobr>"++?_T("ortamdan <b>keyif alarak</b> kendine yeni arkadaşlar, uğraşlar")++"</nobr><br /><nobr>"++?_T("bulup, <b>zevkle</b> vakit geçirebileceği ortamı yaratabilmek için")++"</nobr><br />"++?_T("tasarladık.")},
            ...
            #panel{style="left:81px; top:1313px; font-size:17px; text-indent:-11px;",body="<nobr>"++?_T("<b>• </b>İçerideki her özelliği <b>kullanıcının ihtiyaçlarına</b> göre ve arayıp ta")++"</nobr><br /><nobr>"++?_T("<b>bulamadıklarını</b> düşünerek sadece kakaranet’e <b>özel</b> uygulamalar")++"</nobr><br />"++?_T("hazırladık.")}
        ]},
        #panel{class="info-page-content-panel", body=[
