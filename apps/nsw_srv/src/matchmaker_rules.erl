                ...
                #panel{class=holder, style="margin-left:30px; width:900px; font-size:14px;", body=[
                    #table {rows=[
                        ...
                        #tablerow {cells=[
                            ...
                            #tablecell {style="padding:5px;", body=""},
                            #tablecell {style="padding:5px;", body=""},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="1", align=center},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="2", align=center},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="3", align=center},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="4", align=center},
                            #tablecell {style="padding:5px;", body=""},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="1", align=center},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="2", align=center},
                            #tablecell {style="padding:5px; background-color:#FB7; min-width:15px;", body="3", align=center},
