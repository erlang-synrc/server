...
event({register_success, User}) ->
    timer:sleep(100),   % rarely, but sometimes it simply can't find new user with login:login_user, so I put a delay here
    ...
    timer:sleep(200),    % and this for group subscription
