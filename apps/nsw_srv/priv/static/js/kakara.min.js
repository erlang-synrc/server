 ...
 */
(function($,h,c){var a=$([]),e=$.resize=$.extend($.resize,{}),i,k="setTimeout",j="resize",d=j+"-special-event",b="delay",f="throttleWindow";e[b]=250;e[f]=true;$.event.special[j]={setup:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.add(l);$.data(this,d,{w:l.width(),h:l.height()});if(a.length===1){g()}},teardown:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.not(l);l.removeData(d);if(!a.length){clearTimeout(i)}},add:function(l){if(!e[f]&&this[k]){return false}var n;function m(s,o,p){var q=$(this),r=$.data(this,d);r.w=o!==c?o:q.width();r.h=p!==c?p:q.height();n.apply(this,arguments)}if($.isFunction(l)){n=l;return m}else{n=l.handler;l.handler=m}}};function g(){i=h[k](function(){a.each(function(){var n=$(this),m=n.width(),l=n.height(),o=$.data(this,d);if(m!==o.w||l!==o.h){n.trigger(j,[o.w=m,o.h=l])}});g()},e[b])}}(jQuery,this));jQuery(document).ready(function(c){var b=c("body");var a=function(){var d=c(window).height();var e={650:"small-screen",530:"extra-small-screen"};for(hl in e){if(d<hl){b.addClass(e[hl])}else{b.removeClass(e[hl])}}};a();c(window).resize(a)})
/*!
 ...
 */
;(function(c,d){var b="2.9999.5";if(c.support===d){c.support={opacity:!(c.browser.msie)}}function g(u){if(c.fn.cycle.debug){f(u)}}function f(){if(window.console&&console.log){console.log("[cycle] "+Array.prototype.join.call(arguments," "))}}c.expr[":"].paused=function(s){return s.cyclePause};c.fn.cycle=function(u,s){var v={s:this.selector,c:this.context};if(this.length===0&&u!="stop"){if(!c.isReady&&v.s){f("DOM not ready, queuing slideshow");c(function(){c(v.s,v.c).cycle(u,s)});return this}f("terminating; zero elements found by selector"+(c.isReady?"":" (DOM not ready)"));return this}return this.each(function(){var z=l(this,u,s);if(z===false){return}z.updateActivePagerLink=z.updateActivePagerLink||c.fn.cycle.updateActivePagerLink;if(this.cycleTimeout){clearTimeout(this.cycleTimeout)}this.cycleTimeout=this.cyclePause=0;this.cycleStop=0;var A=c(this);var B=z.slideExpr?c(z.slideExpr,this):A.children();var x=B.get();if(x.length<2){f("terminating; too few slides: "+x.length);return}var w=q(A,B,x,z,v);if(w===false){return}var y=w.continuous?10:m(x[w.currSlide],x[w.nextSlide],w,!w.backwards);if(y){y+=(w.delay||0);if(y<10){y=10}g("first timeout: "+y);this.cycleTimeout=setTimeout(function(){n(x,w,0,!z.backwards)},y)}})};function k(s,w,v){var x=c(s).data("cycle.opts");var u=!!s.cyclePause;if(u&&x.paused){x.paused(s,x,w,v)}else{if(!u&&x.resumed){x.resumed(s,x,w,v)}}}function l(s,w,u){if(s.cycleStop===d){s.cycleStop=0}if(w===d||w===null){w={}}if(w.constructor==String){switch(w){case"destroy":case"stop":var y=c(s).data("cycle.opts");if(!y){return false}s.cycleStop++;if(s.cycleTimeout){clearTimeout(s.cycleTimeout)}s.cycleTimeout=0;if(y.elements){c(y.elements).stop()}c(s).removeData("cycle.opts");if(w=="destroy"){r(s,y)}return false;case"toggle":s.cyclePause=(s.cyclePause===1)?0:1;x(s.cyclePause,u,s);k(s);return false;case"pause":s.cyclePause=1;k(s);return false;case"resume":s.cyclePause=0;x(false,u,s);k(s);return false;case"prev":case"next":y=c(s).data("cycle.opts");if(!y){f('options not found, "prev/next" ignored');return false}c.fn.cycle[w](y);return false;default:w={fx:w}}return w}else{if(w.constructor==Number){var v=w;w=c(s).data("cycle.opts");if(!w){f("options not found, can not advance slide");return false}if(v<0||v>=w.elements.length){f("invalid slide index: "+v);return false}w.nextSlide=v;if(s.cycleTimeout){clearTimeout(s.cycleTimeout);s.cycleTimeout=0}if(typeof u=="string"){w.oneTimeFx=u}n(w.elements,w,1,v>=w.currSlide);return false}}return w;function x(A,B,z){if(!A&&B===true){var C=c(z).data("cycle.opts");if(!C){f("options not found, can not resume");return false}if(z.cycleTimeout){clearTimeout(z.cycleTimeout);z.cycleTimeout=0}n(C.elements,C,1,!C.backwards)}}}function e(s,u){if(!c.support.opacity&&u.cleartype&&s.style.filter){try{s.style.removeAttribute("filter")}catch(v){}}}function r(s,u){if(u.next){c(u.next).unbind(u.prevNextEvent)}if(u.prev){c(u.prev).unbind(u.prevNextEvent)}if(u.pager||u.pagerAnchorBuilder){c.each(u.pagerAnchors||[],function(){this.unbind().remove()})}u.pagerAnchors=null;c(s).unbind("mouseenter.cycle mouseleave.cycle");if(u.destroy){u.destroy(u)}}function q(D,R,A,z,K){var s;var I=c.extend({},c.fn.cycle.defaults,z||{},c.metadata?D.metadata():c.meta?D.data():{});var G=c.isFunction(D.data)?D.data(I.metaAttr):null;if(G){I=c.extend(I,G)}if(I.autostop){I.countdown=I.autostopCount||A.length}var v=D[0];D.data("cycle.opts",I);I.$cont=D;I.stopCount=v.cycleStop;I.elements=A;I.before=I.before?[I.before]:[];I.after=I.after?[I.after]:[];if(!c.support.opacity&&I.cleartype){I.after.push(function(){e(this,I)})}if(I.continuous){I.after.push(function(){n(A,I,0,!I.backwards)})}i(I);if(!c.support.opacity&&I.cleartype&&!I.cleartypeNoBg){a(R)}if(D.css("position")=="static"){D.css("position","relative")}if(I.width){D.width(I.width)}if(I.height&&I.height!="auto"){D.height(I.height)}if(I.startingSlide!==d){I.startingSlide=parseInt(I.startingSlide,10);if(I.startingSlide>=A.length||I.startSlide<0){I.startingSlide=0}else{s=true}}else{if(I.backwards){I.startingSlide=A.length-1}else{I.startingSlide=0}}if(I.random){I.randomMap=[];for(var P=0;P<A.length;P++){I.randomMap.push(P)}I.randomMap.sort(function(T,w){return Math.random()-0.5});if(s){for(var N=0;N<A.length;N++){if(I.startingSlide==I.randomMap[N]){I.randomIndex=N}}}else{I.randomIndex=1;I.startingSlide=I.randomMap[1]}}else{if(I.startingSlide>=A.length){I.startingSlide=0}}I.currSlide=I.startingSlide||0;var C=I.startingSlide;R.css({position:"absolute",top:0,left:0}).hide().each(function(w){var T;if(I.backwards){T=C?w<=C?A.length+(w-C):C-w:A.length-w}else{T=C?w>=C?A.length-(w-C):C-w:A.length-w}c(this).css("z-index",T)});c(A[C]).css("opacity",1).show();e(A[C],I);if(I.fit){if(!I.aspect){if(I.width){R.width(I.width)}if(I.height&&I.height!="auto"){R.height(I.height)}}else{R.each(function(){var T=c(this);var w=(I.aspect===true)?T.width()/T.height():I.aspect;if(I.width&&T.width()!=I.width){T.width(I.width);T.height(I.width/w)}if(I.height&&T.height()<I.height){T.height(I.height);T.width(I.height*w)}})}}if(I.center&&((!I.fit)||I.aspect)){R.each(function(){var w=c(this);w.css({"margin-left":I.width?((I.width-w.width())/2)+"px":0,"margin-top":I.height?((I.height-w.height())/2)+"px":0})})}if(I.center&&!I.fit&&!I.slideResize){R.each(function(){var w=c(this);w.css({"margin-left":I.width?((I.width-w.width())/2)+"px":0,"margin-top":I.height?((I.height-w.height())/2)+"px":0})})}var J=I.containerResize&&!D.innerHeight();if(J){var B=0,H=0;for(var M=0;M<A.length;M++){var u=c(A[M]),S=u[0],F=u.outerWidth(),Q=u.outerHeight();if(!F){F=S.offsetWidth||S.width||u.attr("width")}if(!Q){Q=S.offsetHeight||S.height||u.attr("height")}B=F>B?F:B;H=Q>H?Q:H}if(B>0&&H>0){D.css({width:B+"px",height:H+"px"})}}var y=false;if(I.pause){D.bind("mouseenter.cycle",function(){y=true;this.cyclePause++;k(v,true)}).bind("mouseleave.cycle",function(){if(y){this.cyclePause--}k(v,true)})}if(o(I)===false){return false}var x=false;z.requeueAttempts=z.requeueAttempts||0;R.each(function(){var V=c(this);this.cycleH=(I.fit&&I.height)?I.height:(V.height()||this.offsetHeight||this.height||V.attr("height")||0);this.cycleW=(I.fit&&I.width)?I.width:(V.width()||this.offsetWidth||this.width||V.attr("width")||0);if(V.is("img")){var T=(c.browser.msie&&this.cycleW==28&&this.cycleH==30&&!this.complete);var W=(c.browser.mozilla&&this.cycleW==34&&this.cycleH==19&&!this.complete);var U=(c.browser.opera&&((this.cycleW==42&&this.cycleH==19)||(this.cycleW==37&&this.cycleH==17))&&!this.complete);var w=(this.cycleH===0&&this.cycleW===0&&!this.complete);if(T||W||U||w){if(K.s&&I.requeueOnImageNotLoaded&&++z.requeueAttempts<100){f(z.requeueAttempts," - img slide not loaded, requeuing slideshow: ",this.src,this.cycleW,this.cycleH);setTimeout(function(){c(K.s,K.c).cycle(z)},I.requeueTimeout);x=true;return false}else{f("could not determine size of image: "+this.src,this.cycleW,this.cycleH)}}}return true});if(x){return false}I.cssBefore=I.cssBefore||{};I.cssAfter=I.cssAfter||{};I.cssFirst=I.cssFirst||{};I.animIn=I.animIn||{};I.animOut=I.animOut||{};R.not(":eq("+C+")").css(I.cssBefore);c(R[C]).css(I.cssFirst);if(I.timeout){I.timeout=parseInt(I.timeout,10);if(I.speed.constructor==String){I.speed=c.fx.speeds[I.speed]||parseInt(I.speed,10)}if(!I.sync){I.speed=I.speed/2}var L=I.fx=="none"?0:I.fx=="shuffle"?500:250;while((I.timeout-I.speed)<L){I.timeout+=I.speed}}if(I.easing){I.easeIn=I.easeOut=I.easing}if(!I.speedIn){I.speedIn=I.speed}if(!I.speedOut){I.speedOut=I.speed}I.slideCount=A.length;I.currSlide=I.lastSlide=C;if(I.random){if(++I.randomIndex==A.length){I.randomIndex=0}I.nextSlide=I.randomMap[I.randomIndex]}else{if(I.backwards){I.nextSlide=I.startingSlide===0?(A.length-1):I.startingSlide-1}else{I.nextSlide=I.startingSlide>=(A.length-1)?0:I.startingSlide+1}}if(!I.multiFx){var O=c.fn.cycle.transitions[I.fx];if(c.isFunction(O)){O(D,R,I)}else{if(I.fx!="custom"&&!I.multiFx){f("unknown transition: "+I.fx,"; slideshow terminating");return false}}}var E=R[C];if(!I.skipInitializationCallbacks){if(I.before.length){I.before[0].apply(E,[E,E,I,true])}if(I.after.length){I.after[0].apply(E,[E,E,I,true])}}if(I.next){c(I.next).bind(I.prevNextEvent,function(){return h(I,1)})}if(I.prev){c(I.prev).bind(I.prevNextEvent,function(){return h(I,0)})}if(I.pager||I.pagerAnchorBuilder){p(A,I)}j(I,A);return I}function i(s){s.original={before:[],after:[]};s.original.cssBefore=c.extend({},s.cssBefore);s.original.cssAfter=c.extend({},s.cssAfter);s.original.animIn=c.extend({},s.animIn);s.original.animOut=c.extend({},s.animOut);c.each(s.before,function(){s.original.before.push(this)});c.each(s.after,function(){s.original.after.push(this)})}function o(z){var x,v,u=c.fn.cycle.transitions;if(z.fx.indexOf(",")>0){z.multiFx=true;z.fxs=z.fx.replace(/\s*/g,"").split(",");for(x=0;x<z.fxs.length;x++){var y=z.fxs[x];v=u[y];if(!v||!u.hasOwnProperty(y)||!c.isFunction(v)){f("discarding unknown transition: ",y);z.fxs.splice(x,1);x--}}if(!z.fxs.length){f("No valid transitions named; slideshow terminating.");return false}}else{if(z.fx=="all"){z.multiFx=true;z.fxs=[];for(var A in u){if(u.hasOwnProperty(A)){v=u[A];if(u.hasOwnProperty(A)&&c.isFunction(v)){z.fxs.push(A)}}}}}if(z.multiFx&&z.randomizeEffects){var w=Math.floor(Math.random()*20)+30;for(x=0;x<w;x++){var s=Math.floor(Math.random()*z.fxs.length);z.fxs.push(z.fxs.splice(s,1)[0])}g("randomized fx sequence: ",z.fxs)}return true}function j(u,s){u.addSlide=function(w,x){var v=c(w),y=v[0];if(!u.autostopCount){u.countdown++}s[x?"unshift":"push"](y);if(u.els){u.els[x?"unshift":"push"](y)}u.slideCount=s.length;if(u.random){u.randomMap.push(u.slideCount-1);u.randomMap.sort(function(A,z){return Math.random()-0.5})}v.css("position","absolute");v[x?"prependTo":"appendTo"](u.$cont);if(x){u.currSlide++;u.nextSlide++}if(!c.support.opacity&&u.cleartype&&!u.cleartypeNoBg){a(v)}if(u.fit&&u.width){v.width(u.width)}if(u.fit&&u.height&&u.height!="auto"){v.height(u.height)}y.cycleH=(u.fit&&u.height)?u.height:v.height();y.cycleW=(u.fit&&u.width)?u.width:v.width();v.css(u.cssBefore);if(u.pager||u.pagerAnchorBuilder){c.fn.cycle.createPagerAnchor(s.length-1,y,c(u.pager),s,u)}if(c.isFunction(u.onAddSlide)){u.onAddSlide(v)}else{v.hide()}}}c.fn.cycle.resetState=function(u,s){s=s||u.fx;u.before=[];u.after=[];u.cssBefore=c.extend({},u.original.cssBefore);u.cssAfter=c.extend({},u.original.cssAfter);u.animIn=c.extend({},u.original.animIn);u.animOut=c.extend({},u.original.animOut);u.fxFn=null;c.each(u.original.before,function(){u.before.push(this)});c.each(u.original.after,function(){u.after.push(this)});var v=c.fn.cycle.transitions[s];if(c.isFunction(v)){v(u.$cont,c(u.elements),u)}};function n(z,s,y,B){var w=s.$cont[0],E=z[s.currSlide],C=z[s.nextSlide];if(y&&s.busy&&s.manualTrump){g("manualTrump in go(), stopping active transition");c(z).stop(true,true);s.busy=0;clearTimeout(w.cycleTimeout)}if(s.busy){g("transition active, ignoring new tx request");return}if(w.cycleStop!=s.stopCount||w.cycleTimeout===0&&!y){return}if(!y&&!w.cyclePause&&!s.bounce&&((s.autostop&&(--s.countdown<=0))||(s.nowrap&&!s.random&&s.nextSlide<s.currSlide))){if(s.end){s.end(s)}return}var A=false;if((y||!w.cyclePause)&&(s.nextSlide!=s.currSlide)){A=true;var x=s.fx;E.cycleH=E.cycleH||c(E).height();E.cycleW=E.cycleW||c(E).width();C.cycleH=C.cycleH||c(C).height();C.cycleW=C.cycleW||c(C).width();if(s.multiFx){if(B&&(s.lastFx===d||++s.lastFx>=s.fxs.length)){s.lastFx=0}else{if(!B&&(s.lastFx===d||--s.lastFx<0)){s.lastFx=s.fxs.length-1}}x=s.fxs[s.lastFx]}if(s.oneTimeFx){x=s.oneTimeFx;s.oneTimeFx=null}c.fn.cycle.resetState(s,x);if(s.before.length){c.each(s.before,function(F,G){if(w.cycleStop!=s.stopCount){return}G.apply(C,[E,C,s,B])})}var u=function(){s.busy=0;c.each(s.after,function(F,G){if(w.cycleStop!=s.stopCount){return}G.apply(C,[E,C,s,B])});if(!w.cycleStop){D()}};g("tx firing("+x+"); currSlide: "+s.currSlide+"; nextSlide: "+s.nextSlide);s.busy=1;if(s.fxFn){s.fxFn(E,C,s,u,B,y&&s.fastOnEvent)}else{if(c.isFunction(c.fn.cycle[s.fx])){c.fn.cycle[s.fx](E,C,s,u,B,y&&s.fastOnEvent)}else{c.fn.cycle.custom(E,C,s,u,B,y&&s.fastOnEvent)}}}else{D()}if(A||s.nextSlide==s.currSlide){var v;s.lastSlide=s.currSlide;if(s.random){s.currSlide=s.nextSlide;if(++s.randomIndex==z.length){s.randomIndex=0;s.randomMap.sort(function(G,F){return Math.random()-0.5})}s.nextSlide=s.randomMap[s.randomIndex];if(s.nextSlide==s.currSlide){s.nextSlide=(s.currSlide==s.slideCount-1)?0:s.currSlide+1}}else{if(s.backwards){v=(s.nextSlide-1)<0;if(v&&s.bounce){s.backwards=!s.backwards;s.nextSlide=1;s.currSlide=0}else{s.nextSlide=v?(z.length-1):s.nextSlide-1;s.currSlide=v?0:s.nextSlide+1}}else{v=(s.nextSlide+1)==z.length;if(v&&s.bounce){s.backwards=!s.backwards;s.nextSlide=z.length-2;s.currSlide=z.length-1}else{s.nextSlide=v?0:s.nextSlide+1;s.currSlide=v?z.length-1:s.nextSlide-1}}}}if(A&&s.pager){s.updateActivePagerLink(s.pager,s.currSlide,s.activePagerClass)}function D(){var F=0,G=s.timeout;if(s.timeout&&!s.continuous){F=m(z[s.currSlide],z[s.nextSlide],s,B);if(s.fx=="shuffle"){F-=s.speedOut}}else{if(s.continuous&&w.cyclePause){F=10}}if(F>0){w.cycleTimeout=setTimeout(function(){n(z,s,0,!s.backwards)},F)}}}c.fn.cycle.updateActivePagerLink=function(s,v,u){c(s).each(function(){c(this).children().removeClass(u).eq(v).addClass(u)})};function m(x,v,w,u){if(w.timeoutFn){var s=w.timeoutFn.call(x,x,v,w,u);while(w.fx!="none"&&(s-w.speed)<250){s+=w.speed}g("calculated timeout: "+s+"; speed: "+w.speed);if(s!==false){return s}}return w.timeout}c.fn.cycle.next=function(s){h(s,1)};c.fn.cycle.prev=function(s){h(s,0)};function h(w,v){var z=v?1:-1;var u=w.elements;var y=w.$cont[0],x=y.cycleTimeout;if(x){clearTimeout(x);y.cycleTimeout=0}if(w.random&&z<0){w.randomIndex--;if(--w.randomIndex==-2){w.randomIndex=u.length-2}else{if(w.randomIndex==-1){w.randomIndex=u.length-1}}w.nextSlide=w.randomMap[w.randomIndex]}else{if(w.random){w.nextSlide=w.randomMap[w.randomIndex]}else{w.nextSlide=w.currSlide+z;if(w.nextSlide<0){if(w.nowrap){return false}w.nextSlide=u.length-1}else{if(w.nextSlide>=u.length){if(w.nowrap){return false}w.nextSlide=0}}}}var s=w.onPrevNextEvent||w.prevNextClick;if(c.isFunction(s)){s(z>0,w.nextSlide,u[w.nextSlide])}n(u,w,1,v);return false}function p(u,v){var s=c(v.pager);c.each(u,function(w,x){c.fn.cycle.createPagerAnchor(w,x,s,u,v)});v.updateActivePagerLink(v.pager,v.startingSlide,v.activePagerClass)}c.fn.cycle.createPagerAnchor=function(y,v,A,x,u){var B;if(c.isFunction(u.pagerAnchorBuilder)){B=u.pagerAnchorBuilder(y,v);g("pagerAnchorBuilder("+y+", el) returned: "+B)}else{B='<a href="#">'+(y+1)+"</a>"}if(!B){return}var w=c(B);if(w.parents("body").length===0){var z=[];if(A.length>1){A.each(function(){var E=w.clone(true);c(this).append(E);z.push(E[0])});w=c(z)}else{w.appendTo(A)}}u.pagerAnchors=u.pagerAnchors||[];u.pagerAnchors.push(w);var C=function(H){H.preventDefault();u.nextSlide=y;var G=u.$cont[0],F=G.cycleTimeout;if(F){clearTimeout(F);G.cycleTimeout=0}var E=u.onPagerEvent||u.pagerClick;if(c.isFunction(E)){E(u.nextSlide,x[u.nextSlide])}n(x,u,1,u.currSlide<y)};if(/mouseenter|mouseover/i.test(u.pagerEvent)){w.hover(C,function(){})}else{w.bind(u.pagerEvent,C)}if(!/^click/.test(u.pagerEvent)&&!u.allowPagerClickBubble){w.bind("click.cycle",function(){return false})}var D=u.$cont[0];var s=false;if(u.pauseOnPagerHover){w.hover(function(){s=true;D.cyclePause++;k(D,true,true)},function(){if(s){D.cyclePause--}k(D,true,true)})}};c.fn.cycle.hopsFromLast=function(w,v){var u,s=w.lastSlide,x=w.currSlide;if(v){u=x>s?x-s:w.slideCount-s}else{u=x<s?s-x:s+w.slideCount-x}return u};function a(v){g("applying clearType background-color hack");function u(w){w=parseInt(w,10).toString(16);return w.length<2?"0"+w:w}function s(y){for(;y&&y.nodeName.toLowerCase()!="html";y=y.parentNode){var w=c.css(y,"background-color");if(w&&w.indexOf("rgb")>=0){var x=w.match(/\d+/g);return"#"+u(x[0])+u(x[1])+u(x[2])}if(w&&w!="transparent"){return w}}return"#ffffff"}v.each(function(){c(this).css("background-color",s(this))})}c.fn.cycle.commonReset=function(z,x,y,u,v,s){c(y.elements).not(z).hide();if(typeof y.cssBefore.opacity=="undefined"){y.cssBefore.opacity=1}y.cssBefore.display="block";if(y.slideResize&&u!==false&&x.cycleW>0){y.cssBefore.width=x.cycleW}if(y.slideResize&&v!==false&&x.cycleH>0){y.cssBefore.height=x.cycleH}y.cssAfter=y.cssAfter||{};y.cssAfter.display="none";c(z).css("zIndex",y.slideCount+(s===true?1:0));c(x).css("zIndex",y.slideCount+(s===true?0:1))};c.fn.cycle.custom=function(F,z,s,w,y,u){var E=c(F),A=c(z);var v=s.speedIn,D=s.speedOut,x=s.easeIn,C=s.easeOut;A.css(s.cssBefore);if(u){if(typeof u=="number"){v=D=u}else{v=D=1}x=C=null}var B=function(){A.animate(s.animIn,v,x,function(){w()})};E.animate(s.animOut,D,C,function(){E.css(s.cssAfter);if(!s.sync){B()}});if(s.sync){B()}};c.fn.cycle.transitions={fade:function(u,v,s){v.not(":eq("+s.currSlide+")").css("opacity",0);s.before.push(function(y,w,x){c.fn.cycle.commonReset(y,w,x);x.cssBefore.opacity=0});s.animIn={opacity:1};s.animOut={opacity:0};s.cssBefore={top:0,left:0}}};c.fn.cycle.ver=function(){return b};c.fn.cycle.defaults={activePagerClass:"activeSlide",after:null,allowPagerClickBubble:false,animIn:null,animOut:null,aspect:false,autostop:0,autostopCount:0,backwards:false,before:null,center:null,cleartype:!c.support.opacity,cleartypeNoBg:false,containerResize:1,continuous:0,cssAfter:null,cssBefore:null,delay:0,easeIn:null,easeOut:null,easing:null,end:null,fastOnEvent:0,fit:0,fx:"fade",fxFn:null,height:"auto",manualTrump:true,metaAttr:"cycle",next:null,nowrap:0,onPagerEvent:null,onPrevNextEvent:null,pager:null,pagerAnchorBuilder:null,pagerEvent:"click.cycle",pause:0,pauseOnPagerHover:0,prev:null,prevNextEvent:"click.cycle",random:0,randomizeEffects:1,requeueOnImageNotLoaded:true,requeueTimeout:250,rev:0,shuffle:null,skipInitializationCallbacks:false,slideExpr:null,slideResize:1,speed:1000,speedIn:null,speedOut:null,startingSlide:d,sync:1,timeout:4000,timeoutFn:null,updateActivePagerLink:null,width:null}})(jQuery);
/*!
