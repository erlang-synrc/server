...
users_list() ->
    FirstCursor = cursor:new_fun(nsm_db:all(user), fun(#user{register_date=A}, #user{register_date=B}) -> A>B end),
...
gifts_list_get_data(Items) ->
    [ begin [unicode:characters_to_binary(Name),
                     integer_to_list(Vendor),
                     integer_to_list(ExtId),
    ...
    #table{class="nice_table",
           header=[#tablerow{class="nice_table_header",
                           cells=[#tableheader{class="first-row", text=?_T("Name")},
                                  #tableheader{text=?_T("Vendor")},
                                  #tableheader{text=?_T("ExtId")},
           ...
           rows=[
                 #bind{transform=fun tf_mark_odd/2,
                       data=Items, map=[ gift_list_name@text, gift_list_vendor@text, gift_list_extid@text,
                                         gift_list_real@text,
                       ...
                       body=[#tablerow{id=table_row,
                                              ...
                                              #tablecell{id=gift_list_vendor},
                                              #tablecell{id=gift_list_extid},
