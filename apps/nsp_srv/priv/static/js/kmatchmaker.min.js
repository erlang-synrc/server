...
/*
paginateTable 1.6+jl
Copyright 2011, JLarky <jlarky@gmail.com>
  ...
  $.fn.paginateTable = function(options) {
      ...
      return this.each(function(){
          ...
          nextPage.click(function(){
                  var pageNum = getCurrentPage(pager);
          ...
          displayPage(table, getCurrentPage(pager), settings);
      });
  };
  
  function getCurrentPage(pager){
      var pageNum = pager.data('current');
      if (isNaN(pageNum)){
          pageNum = 0;
      }
      ...
      if (settings.rowsPerPage > 0){
          ...
          if (settings.autoHidePager && totalPages <= 1){
              ...
              if (pageNumbers.size() > 0){
		       ...
		       if (current) {
			   pager.data('current', i);
		       }
                       pageNumbers.append("<li><a href='#' id='" + i + "' class='" + current + "'>" + i + "</a></li>");
                   }
...
// @depends ../nitrogen/jquery.paginatetable.js
