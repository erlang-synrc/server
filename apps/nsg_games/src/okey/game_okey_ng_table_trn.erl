...
init([GameId, TableId, Params]) ->
    ...
    ScoringState = proplists:get_value(scoring_state, Params, ?SCORING:init(GameType, ?SEATS_NUM)),
...
finalize_round(#state{desk_state = #desk_state{finish_reason = FinishReason,
    ...
    FR = case FinishReason of
             ...
             reveal ->
                 {Revealer, Tashes, Discarded} = RevealInfo,
    ...
    if GameOver ->
           %% TODO: Define game winners and pass them to the parent
